...
public class SonrCorePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    // Initialize Channels
    methodChannel =
        new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "io.sonr.plugin/action");

    eventChannel =
        new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "io.sonr.plugin/event");
