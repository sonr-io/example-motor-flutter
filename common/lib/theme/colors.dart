...
class AppColors {
  ...
  static const primary1 = Color(0xff1792ff);
  ...
  static const otherPlatformsIOS = Color(0xff863a83);

  static const otherPlatformsMacOs = Color(0xff81b8fb);

  static const otherPlatformsAndroid = Color(0xff5ad380);

  static const otherPlatformsWindows = Color(0xff204ed8);

  static const otherPlatformsLinux = Color(0xfff4af3f);
