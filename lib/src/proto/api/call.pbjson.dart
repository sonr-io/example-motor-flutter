...
const InitializeRequest_DeviceOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'folders', '3': 2, '4': 3, '5': 11, '6': '.sonr.api.InitializeRequest.DeviceOptions.FoldersEntry', '10': 'folders'},
  ],
  '3': const [InitializeRequest_DeviceOptions_FoldersEntry$json],
};

@$core.Deprecated('Use initializeRequestDescriptor instead')
const InitializeRequest_DeviceOptions_FoldersEntry$json = const {
  '1': 'FoldersEntry',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 9, '10': 'value'},
...
final $typed_data.Uint8List initializeRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List initializeResponseDescriptor = $convert.base64Decode('');
...
const FetchResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'recents', '3': 5, '4': 3, '5': 11, '6': '.sonr.api.FetchResponse.RecentsEntry', '10': 'recents'},
    const {'1': 'history', '3': 6, '4': 3, '5': 11, '6': '.sonr.api.FetchResponse.HistoryEntry', '10': 'history'},
  ],
...
final $typed_data.Uint8List fetchResponseDescriptor = $convert.base64Decode('');
